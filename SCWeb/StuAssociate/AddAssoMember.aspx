<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAssoMember.aspx.cs" Inherits="SCWeb.StuAssociate.AddAssoMember" %>
...
<body style="background:#fff;">
        ...
        <div class="clearfix tools">
            <div class="fr tools_right">
                <div class="search_wrap pr ml20 fl" style="width: 170px;">
                    <input type="text" id="txtUserName" class="search" placeholder="搜索学生姓名" />
    ...
    <script type="text/javascript">
        ...
        //获取社团成员
        function GetAssoMember() {
            $.ajax({
                url: "/Common.ashx",
                type: "post",
                async: false,
                dataType: "json",
                data: { PageName: "/StuAssociate/Asso_InfoHandler.ashx", Func: "GetAssoInfoById", ItemId: UrlDate.relid, },
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
                        ...
                        $.ajax({
                            ...
                            async: false,
                            dataType: "json",
                            data: { PageName: "/StuAssociate/Asso_InfoHandler.ashx", Func: "GetAssoMemberDataPage", LoginUID: "<%=UserInfo.UniqueNo%>", AssoId: UrlDate.relid, ispage: false },
                            success: function (json) {
                                if (json.result.errNum.toString() == "0") {
