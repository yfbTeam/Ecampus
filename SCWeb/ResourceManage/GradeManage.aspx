<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GradeManage.aspx.cs" Inherits="SCWeb.ResourceManage.GradeManage" %>
        ...
        <table class="table" id="tb_CatalogList">
            <thead>
                <tr class="trth">
                    ...
                    <th class="Project_name" style="width: 60%;">年级名称</th>
                    <th>操作</th>
                </tr>
            </thead>
            <tbody></tbody>
